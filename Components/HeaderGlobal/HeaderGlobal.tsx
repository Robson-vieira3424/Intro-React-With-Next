        ...
        <nav className="nav__menu__global">
          ...
          <ul className="lista__nav__menu__global">
            <li className="item__nav__menu__global">
              <a className="link__nav__menu__global" href="/dashboard">
                <LuLayoutDashboard fontSize={20} />
                dashboard
              </a>
            </li>
            <li className="item__nav__menu__global">
              <a className="link__nav__menu__global" href="/estoque">
                <BsBoxSeam fontSize={18} />
                estoque
              </a>
            </li>
            <li className="item__nav__menu__global">
              <a className="link__nav__menu__global" href="/movimentacoes">
                <LuArrowLeftRight fontSize={18} />
                movimentações
              </a>
            </li>
            <li className="item__nav__menu__global">
              <a className="link__nav__menu__global" href="/manutencao">
                <GrConfigure fontSize={18} />
                manutenção
              </a>
            </li>
            <li className="item__nav__menu__global">
              <a className="link__nav__menu__global" href="/levantamento">
                <PiClipboardTextBold fontSize={20} />
                levantamento
              </a>
            </li>
            <li className="item__nav__menu__global">
              <a className="link__nav__menu__global" href="/relatorios">
                <BsFileEarmarkText fontSize={20} /> relatórios
              </a>
            </li>
            <li className="item__nav__menu__global">
              <a className="link__nav__menu__global" href="/configuracoes">
